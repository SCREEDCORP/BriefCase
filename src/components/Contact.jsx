        ...
        <Section id="contact">
            ...
            <div className="contact-content">
                <div  
                    ...
                    style={styleDes}
                >
                    <h3 className="user">@jesushf13</h3>
                    <p>Feel free to leave a message in any of my socials.</p>
                </div>
                <div className="contact-icons">
                    <a href="https://github.com/SCREEDCORP" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://www.linkedin.com/in/jesusfoundernext/" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://www.instagram.com/jesushf13/" target="_blank" rel="noreferrer">
                        <svg className="icon-contact" data-name="Layer 1" id="Layer_1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title/>
                    ...
                    <a href="mailto:jesus_f_h_2013@hotmail.com?Subject=Hi!%20I%20Saw%20your%20portfolio!" target="_blank" rel="noreferrer">
